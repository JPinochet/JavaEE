...
public class Controller extends HttpServlet {
    ...
    throws ServletException, IOException {
	   ...
	   if (uab.resetPassswordUser(currentUser, oldPassword, newPassword1, newPassword2))
	       response.sendRedirect("main.jsp?message=Password updated");
	   else
	       response.sendRedirect("main.jsp?message=Error updating password!!!");
       }
	   ...
	   if (uab.resetPasswordAdmin(reset))
	       response.sendRedirect("admin.jsp?message=Password reset");
	   else
		response.sendRedirect("admin.jsp?message=Error resetting password!!!");
       }
