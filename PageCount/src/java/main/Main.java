...
public class Main extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<a href=\"Validate?username=" + username + "&loggedIn=" + loggedIn + "&pageCount=" + (Integer.parseInt(pageCount) + 1) +"\">Refresh</a>");

            out.println("<hr>");
            out.println("<form name=\"hiddenForm\" action=\"Validate\" method=\"POST\">");
